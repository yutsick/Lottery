export default function () {
    ...
    // let slider = document.querySelector('.product-slider__big-box');
    // let options = {
    //     zoomPosition: 'original',
    // };
    // function zoom(evt) {
    //     if(evt.target.parentNode.classList.contains("is-selected")) {
    //         new ImageZoom(evt.target.parentNode, options);
    //     }
    // }
    // slider.addEventListener('mouseover', zoom);

    document.querySelectorAll('.product-slider__item--large').forEach(el => {
        new ImageZoom(el, {
            fillContainer: true,
